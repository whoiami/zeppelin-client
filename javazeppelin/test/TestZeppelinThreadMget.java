...
public class TestZeppelinThreadMget extends Thread {
  int pauseTime;
  public TestZeppelinThreadMget(int pTime) {
  ...
  public static void main(String[] args) {
    for (int i = 1; i <= 100; i++) {
      TestZeppelinThreadMget tqt = new TestZeppelinThreadMget(i);
      tqt.start();
    }
  }
